...
export const executiveDomains: ExecutiveDomain[] = [
  ...
  },
  {
    ...
    code: 'DGN',
    name: 'AI Diagnostics',
    role: 'Symptom, evidence and test-plan intelligence',
    state: 'planned',
    health: 42,
    description:
      'The future reasoning layer that will transform symptoms and evidence into ranked causes, test plans and report-ready conclusions.',
...
export const executiveActions: ExecutiveAction[] = [
  ...
  },
  {
    ...
    detail: 'Capture symptoms and evidence for guided diagnosis.',
    command: 'diagnose',
    domain: 'diagnostics',
    status: 'planned',
  },
