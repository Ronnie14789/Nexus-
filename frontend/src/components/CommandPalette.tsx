...
const commands = [
  ...
  { key: '04', label: 'AI Diagnostics', detail: 'Rank probable causes, build test plans and generate report-ready findings', href: '/ai-diagnostics' },
  { key: '05', label: 'Engineering Knowledge Vault', detail: 'Search procedures, field cases, diagnostics, standards and verification evidence', href: '/knowledge-vault' },
  { key: '05', label: 'Electrical systems', detail: 'Power, protection, control and diagnostics', href: '/electrical-systems' },
  { key: '06', label: 'Automotive systems', detail: 'Powertrain, chassis, control and root-cause diagnostics', href: '/automotive-systems' },
  { key: '07', label: 'Digital systems', detail: 'Architecture, data, cloud, security and operations', href: '/digital-systems' },
  { key: '08', label: 'Experience', detail: 'Roles and responsibilities', href: '#experience' },
  { key: '09', label: 'Education', detail: 'Uganda and India', href: '#education' },
  { key: '10', label: 'Journey', detail: 'Uganda → India → Uganda', href: '#journey' },
  { key: '11', label: 'Selected work', detail: 'Case studies and systems', href: '#work' },
  { key: '12', label: 'Training archive', detail: 'SkillPro visual record', href: '#gallery' },
  { key: '13', label: 'Contact', detail: 'First-party secure contact form', href: '#contact' },
  { key: '14', label: 'About Ecatu Ronald', detail: 'Professional identity and verified profiles', href: '/about' },
];
